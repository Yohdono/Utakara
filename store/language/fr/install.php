...
/**
*
* install.php [French (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'ADMIN_USERNAME_EXPLAIN'	=> 'Veuillez saisir un identifiant compris entre 3 et 20 caractères de long.',
	...
	'COLLIDING_CLEAN_USERNAME'	=> '<strong>%s</strong> est l’identifiant propre pour :',
	'COLLIDING_USERNAMES_FOUND'	=> 'Des noms d’utilisateurs similaires ont été trouvés sur votre ancien forum. Pour accomplir la conversion correctement, vous devez supprimer ou renommer ces utilisateurs de sorte que chaque identifiant soit unique.',
	'COLLIDING_USER'	=> '» identification de l’utilisateur : <strong>%d</strong> l’identifiant : <strong>%s</strong> (%d messages)',
	...
	'DB_USERNAME'	=> 'L’identifiant de la base de données',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '		Vous avez installé phpBB %1$s avec succès. Veuillez continuer en sélectionnant une des options suivantes :</p>
	...
	<ul>
		...
		<li>l’identifiant et mot de passe de la base de données (les informations de connexion afin d’accéder à la base de données).</li>
	</ul>

	<p><strong>Note :</strong> si vous procédez à une installation en utilisant SQLite, vous devriez saisir le chemin complet de votre fichier de la base de données dans le champ DNS et laisser le champ de l’identifiant et du mot de passe vide. Pour des raisons de sécurité, vous devriez vous assurer que le fichier de la base de données ne soit pas stocké dans un endroit accessible depuis Internet.</p>
	...
	'INST_ERR_FTP_LOGIN'	=> 'Impossible de se connecter au serveur FTP. Veuillez vérifier votre identifiant et votre mot de passe.',
	...
	'INST_ERR_USER_TOO_LONG'	=> 'L’identifiantr que vous avez saisi est trop long. La longueur maximale est de 20 caractères.',
	'INST_ERR_USER_TOO_SHORT'	=> 'L’identifiant que vous avez saisi est trop court. La longueur minimale est de 3 caractères.',
	...
	'NO_LOCATION'	=> 'Impossible de déterminer l’emplacement. Vous pourrez toujours spécifier ultérieurement l’emplacement d’Imagemagick depuis le panneau de contrôle de l’administrateur.',
	...
	'STAGE_ADVANCED_EXPLAIN'	=> 'Les réglages de cette page ne sont nécessaires que s’ils sont différents des réglages par défaut. Si vous avez un doute, continuez vers l’étape suivante sans modifier ces réglages. Vous pourrez toujours les modifier ultérieurement depuis le panneau de contrôle de l’administrateur.',
	...
	'UPDATE_TOPICS_POSTED_ERR'	=> 'Une erreur est survenue lors de la création des informations sur les sujets publiés. Une fois la procédure de conversion terminée, vous pouvez recommencer cette étape depuis le panneau de contrôle de l’administrateur.',
	...
	'BOT'	=> 'Robot',
	'CHANGE_CLEAN_NAMES'	=> 'La méthode que vous utilisez afin de vous assurer que chaque identifiant ne soit pas utilisé par plusieurs utilisateurs a été modifiée avec succès. Cependant, il est possible que certains utilisateurs utilisent toujours le même identifiant. Avant de continuer, vous devez supprimer ou renommer ces utilisateurs afin de vous assurer que chaque identifiant soit unique.',
	...
	'CONTINUE_UPDATE_NOW'	=> 'Continuer maintenant la procédure de mise à jour',
	'CONTINUE_UPDATE'	=> 'Continuer maintenant la mise à jour',
	...
	'KEEP_OLD_NAME'	=> 'Conserver l’identifiant',
	...
	'NEW_USERNAME'	=> 'Nouveau identifiant',
