...
/**
*
* common.php [French (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'ACP'	=> 'Panneau de configuration',
	'ACTIVE'	=> 'Actif',
	'ACTIVE_ERROR'	=> 'L’identifiant indiqué n’est pas actif. Si vous avez des problèmes pour activer votre compte, contactez l’administrateur du forum.',
	...
	'ATTACHED_IMAGE_NOT_IMAGE'	=> 'L’image que vous essayez d\'ajouter n’est pas valide.',
	'AUTHOR'	=> 'Auteur',
	'AUTH_NO_PROFILE_CREATED'	=> 'Impossible de créer le nouveau profil de l’utilisateur.',
	'AVATAR_DISALLOWED_CONTENT'	=> 'Le chargement est annulé car le fichier envoyé a été identifié comme un vecteur éventuel d’attaque.',
	...
	'AVATAR_EMPTY_FILEUPLOAD'	=> 'Le fichier avatar ne contient aucune image.',
	'AVATAR_INVALID_FILENAME'	=> 'Le nom de fichier %s n’est pas valide.',
	...
	'AVATAR_PARTIAL_UPLOAD'	=> 'Le fichier n’a pas été chargé complètement.',
	...
	'BAN_TRIGGERED_BY_USER'	=> 'Votre identifiant a été banni.',
	...
	'ERR_UNABLE_TO_LOGIN'	=> 'L’identifiant ou le mot de passe indiqué est incorrect.',
	...
	'FORUM'	=> 'Forums',
	'FORUMS'	=> 'Forums',
	'FORUMS_MARKED'	=> 'Tous les fora ont été indiqués en lus.',
	...
	'FORUM_RULES_LINK'	=> 'Cliquez pour afficher les règles du forum',
	'FROM'	=> 'de',
	...
	'FTP_FSOCK_USERNAME'	=> 'Identifiant FTP',
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> 'Identifiant utilisé pour se connecter à votre serveur.',
	...
	'FTP_USERNAME_EXPLAIN'	=> 'Identifiant utilisé pour se connecter à votre serveur.',
	...
	'G_NEWLY_REGISTERED'	=> 'Nouveaux utilisateurs inscrits',
	...
	'HIDE_GUESTS'	=> 'Ne pas afficher les invités',
	...
	'LOGIN_ERROR_ATTEMPTS'	=> 'Vous avez dépassé le maximum autorisé de tentatives de connexion. En plus de vos identifiant et mot de passe, vous devez maintenant entrer le code de confirmation visuelle que vous voyez ci-dessous.',
	...
	'LOGIN_ERROR_USERNAME'	=> 'Vous avez indiqué un identifiant incorrect. Vérifiez votre identifiant et réessayez. Si vous continuez à rencontrer des problèmes, contactez l’%sadministrateur du forum%s.',
	'LOGIN_FORUM'	=> 'Pour lire ou poster dans ce forum, vous devez entrer son mot de passe.',
	'LOGIN_INFO'	=> 'Vous devez être inscrit pour vous connecter. L’enregistrement ne prend que quelques secondes et augmente vos possibilités. L’administrateur du forum peut également accorder des permissions additionnelles aux utilisateurs inscrits. Avant de vous enregistrer, assurez-vous d’avoir pris connaissance de nos conditions d’utilisation et de notre politique de vie privée. Assurez-vous de bien lire tout le règlement du forum.',
	'LOGIN_VIEWFORUM'	=> 'L’administrateur du forum exige que vous soyez inscrit et connecté pour lire ce forum.',
	'LOGIN_EXPLAIN_EDIT'	=> 'Pour éditer des messages dans ce forum, vous devez être inscrit et connecté.',
	'LOGIN_EXPLAIN_VIEWONLINE'	=> 'Pour consulter la liste des utilisateurs en ligne, vous devez être inscrit et connecté.',
	'LOGOUT'	=> 'Déconnexion',
	'LOGOUT_USER'	=> 'Déconnexion [ %s ]',
	'LOG_ME_IN'	=> 'Me connecter à chaque visite',
	'MARK'	=> 'Cocher',
	'MARK_ALL'	=> 'Tout cocher',
	'MARK_FORUMS_READ'	=> 'Indiquer les fora en lus',
	'MB'	=> 'Mo',
	'MIB'	=> 'Mio',
	'MCP'	=> 'Interface de paramétrage',
	'MEMBERLIST'	=> 'Membres',
	'MEMBERLIST_EXPLAIN'	=> 'Afficher la liste complète des inscrits',
	'MERGE'	=> 'Fusionner',
	...
	'MSNM'	=> 'MSNM/WLM',
	'NA'	=> 'N/A',
	'NEWEST_USER'	=> 'L’utilisateur inscrit le plus récent est <strong>%s</strong>',
	...
	'NO_BIRTHDAYS'	=> 'Il n’y a pas d’anniversaire en ce jour',
	...
	'NO_MESSAGES'	=> 'Pas de nouveau message',
	...
	'NO_SUBJECT'	=> 'Aucun sujet indiqué',
	...
	'NO_USER_SPECIFIED'	=> 'Aucun identifiant indiqué.',

	'NUM_POSTS_IN_QUEUE'	=> array(
		'0'	=> 'Aucun message en attente',
		'1'	=> '1 message en attente',
		'2'	=> '%d messages en attente',
	),
	...
	'ONLINE_USERS_TOTAL'	=> 'Actuellement sur le site il y a <strong>%d</strong> visiteurs :: ',
	'ONLINE_USERS_ZERO_TOTAL'	=> 'Actuellement sur le site il y a <strong>0</strong> visiteur :: ',
	'ONLINE_USER_TOTAL'	=> 'Actuellement sur le site il y a <strong>%d</strong> visiteur :: ',
	'OPTIONS'	=> 'Options',
	...
	'POST_REPLY'	=> 'Répondre',
	'POST_REPORTED'	=> 'Cliquer pour afficher le rapport',
	...
	'READ_PROFILE'	=> 'Profil',
	'REASON'	=> 'Raison',
	'RECORD_ONLINE_USERS'	=> 'Le forum a atteint le pic de <strong>%1$s</strong> visiteurs simultanés, le %2$s',
	'REDIRECT'	=> 'Rediriger',
	...
	'RETURN_INDEX'	=> '%sRetourner à l’accueil du forum%s',
	...
	'FEED_TOPICS_ACTIVE'	=> 'Sujets populaires',
	...
	'SEARCH_ADV'	=> 'Recherche détaillée',
	'SEARCH_ADV_EXPLAIN'	=> 'Afficher les options de recherche détaillée',
	'SEARCH_KEYWORDS'	=> 'Recherche par mots-clés',
	'SEARCHING_FORUMS'	=> 'Recherche dans les forums',
	'SEARCH_ACTIVE_TOPICS'	=> 'Afficher les sujets populaires',
	'SEARCH_FOR'	=> 'Rechercher',
	'SEARCH_FORUM'	=> 'Dans ce forum…',
	'SEARCH_NEW'	=> 'Afficher les nouveaux messages',
	'SEARCH_POSTS_BY'	=> 'Rechercher les messages de',
	'SEARCH_SELF'	=> 'Afficher mes messages',
	'SEARCH_TOPIC'	=> 'Dans ce sujet…',
	'SEARCH_UNANSWERED'	=> 'Sélectionner les messages sans répliques',
	'SEARCH_UNREAD'	=> 'Sélectionner les messages non consultés',
	'SECONDS'	=> 'secondes',
	'SELECT'	=> 'Sélectionner',
	...
	'SEND_EMAIL_USER'	=> 'Envoyer un e-mail à',
	...
	'STOP_WATCHING_FORUM'	=> 'Stopper la surveillance de ce forum',
	'STOP_WATCHING_TOPIC'	=> 'Stopper la surveillance de ce sujet',
	'SUBFORUM'	=> 'Sous-forum',
	...
	'TOO_LONG_USERNAME'	=> 'L’identifiant indiqué est trop long.',
	...
	'TOO_SHORT_USERNAME'	=> 'L’identifiant indiqué est trop court.',
	...
	'VIEWING_ONLINE'	=> 'Regarde qui est connecté',
	...
	'VIEW_LATEST_POST'	=> 'Afficher le dernier message',
	'VIEW_NEWEST_POST'	=> 'Afficher le premier message non lu',
	'VIEW_NOTES'	=> 'Notes sur l’utilisateur',
	'VIEW_ONLINE_TIME'	=> 'établis sur les visiteurs actifs des 60 dernières seconde',
	'VIEW_ONLINE_TIMES'	=> 'établis sur les visiteurs actifs des %d dernières minutes',
	'VIEW_TOPIC'	=> 'Afficher le sujet',
	'VIEW_TOPIC_ANNOUNCEMENT'	=> 'Annonce: ',
	'VIEW_TOPIC_GLOBAL'	=> 'Annonce globale: ',
	'VIEW_TOPIC_LOCKED'	=> 'Verrouillé: ',
	'VIEW_TOPIC_LOGS'	=> 'Afficher les journaux',
	...
	'YES'	=> 'Oui',
	'YIM'	=> 'YIM',
	'YOU_LAST_VISIT'	=> 'Dernièr passage le %s',
	...
	'ASSIGNED'	=> 'Assigner',
	'DATE'	=> 'Date',
	'DEV_DIRECTOR'	=> 'Développeur',
	'EDIT'	=> 'Editer',
	'FINISHED'	=> 'Fini',
	'GRADE'	=> 'Note',
	'HOW_INSTALL'	=> 'Comment installer',
	'KARA_ASK'	=> 'Demander votre karaoke',
	'KARA_EDIT'	=> 'Panneaux d\\édition de karaoke',
	'KARA_TO_ASK'	=> 'Que voulez-vous?',
	'KARAOKE'	=> 'Karaoke',
	'LIST'	=> 'Liste',
	'NOACCEPTED'	=> 'Refuser',
	'ORIGIN'	=> 'Origine',
	'PARTNER_DIRECTOR'	=> 'Partenariat',
	'SECRETA_DIRECTOR'	=> 'Secrétaire',
	'SEE_TUTO'	=> 'Très bientot',
	'TECHNIC_DIRECTOR'	=> 'Directeur technique',
	'TITLE'	=> 'Titre',
	'U_CREATE'	=> 'Demande',
	'U_LIST'	=> 'Liste',
	'UTA_ACCEPT'	=> 'L\'état de vos demande',
	'UTA_NOTE'	=> 'Noter le karaoke',
	'UTA_WHERE_FROM'	=> 'D\'où cela provient',
	'UTAKARA_DIRECTOR'	=> 'Directeur Utakara',
	'UTAKARA_GROUP'	=> 'Groupe Utakara',
	'WEB_DIRECTOR'	=> 'Directeur web',
	'ONHOLD' => 'En attente',
	'TRANSFER' => '{ TRANSFERT }',
	'TIMER' => 'menu de gestion du Timeur',
	'TIMER_PANEL' => 'panneau du Timeur',
	'ALREADY_TIMER' => 'Vous êtes déjà inscrit comme Timeur',
	'BE_TIME' => 'Devenir Timeur',
	'BE_TIMER_SUCCESS' => 'Félicitation! Vous êtes maintenant un Timeur de Karaoké!',
	'TO_TIME_LIST' => 'Liste des Times manquants',
	'TIME_NOT_FOUND' => 'Aucun Time ne correspond',
	'TIME_EDIT' => 'Editer un Time',
	'ME' => 'Moi',
	'TIMER_NOT_CONNECTED' => 'Vous devez avoir le statut de Timer pour accéder à cette page',
	'MY_TODO_LIST' => 'Ma liste de Tache',
	'WANT_TIME' => 'Ajouter à ma liste de tache',
	'UNWANT_TIME' => 'Supprimer de ma liste de tache',
	'INTEGRATED' => 'Ce Karaoke existe déjà dans notre base de donnée',
	'REFUSED' => 'Karaoké refusé',
	'REQUEST_SUCCESS' => 'Votre demande a été ajouté',
	'REQUEST_FAILED' => 'Votre demande n\'a pas été ajouté à la liste',
	'ASSIGN_SUCCESS' => 'Le Time a bien été assigné',
	'ASSIGN_FAILED' => 'L\'assignation du Time a échoué',
	'UNASSIGN_SUCCESS' => 'Le Time a bien été déalloué',
	'UNASSIGN_FAILED' => 'la déallocation du Time a échoué',
	'TIME_REFUSED' => 'Time refusé',
	'TIME_REFUSED_FAILED' => 'Echec de refus d\'un Time',
	'TIME_DELETED' => 'Time supprimé',
	'TIME_DELETED_FAILED' => 'Echec de la suppression d\'un time',
	'STATE' => 'Etat',
