...
/**
*
* ucp.php [French (Formal Honorifics)]
*
* @package language
* @version $Id: $
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ADDED'	=> 'Nous vous remercions de votre inscription, votre compte est dorénavant créé. Vous pouvez à présent vous connecter avec votre identifiant et votre mot de passe.',
	...
	'ADD_FOES_EXPLAIN'	=> 'Vous devez saisir chaque identifiant sur une ligne différente.',
	'ADD_FOLDER'	=> 'Ajouter un dossier',
	'ADD_FRIENDS'	=> 'Ajouter de nouveaux amis',
	'ADD_FRIENDS_EXPLAIN'	=> 'Vous devez saisir chaque identifiant sur une ligne différente.',
	'ADD_NEW_RULE'	=> 'Ajouter une nouvelle règle',
	'ADD_RULE'	=> 'Ajouter une règle',
	'ADD_TO'	=> 'Ajouter [À]',
	'ADD_USERS_UCP_EXPLAIN'	=> 'Vous pouvez ajouter ici de nouveaux utilisateurs à un groupe. Vous pouvez décider que ce groupe deviendra le nouveau groupe par défaut pour les utilisateurs sélectionnés. Veuillez saisir chaque identifiant sur une ligne différente.',
	...
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Vous devez confirmer votre mot de passe actuel si vous souhaitez modifier votre mot de passe, votre adresse e-mail ou votre identifiant.',
	...
	'INVALID_CHARS_USERNAME'	=> 'L’identifiant que vous avez spécifié contient des caractères non autorisés.',
	...
	'NO_EMAIL_USER'	=> 'Les informations concernant l’e-mail ou l’identifiant sont introuvables.',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'L’identifiant doit être compris entre %1$d et %2$d caractères de long et ne doit contenir que des caractères alphanumériques.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'	=> 'L’identifiant doit être compris entre %1$d et %2$d caractères de long et doit contenir des caractères alphanumériques, des espaces ou des caractères -+_[].',
	'USERNAME_ASCII_EXPLAIN'	=> 'L’identifiant doit être compris entre %1$d et %2$d caractères de long et ne doit contenir que des caractères ASCII, donc aucun symboles spéciaux.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'L’identifiant doit être compris entre %1$d et %2$d caractères de long et ne doit contenir que des lettres ou des nombres.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'	=> 'L’identifiant doit être compris entre %1$d et %2$d caractères de long et doit contenir des lettres, des nombres, des espaces ou des caractères -+_[].',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'La longueur doit être comprise entre %1$d et %2$d caractères.',
	'USERNAME_TAKEN_USERNAME'	=> 'L’identifiant que vous avez saisi est déjà utilisé, veuillez en choisir un autre.',
	'USERNAME_DISALLOWED_USERNAME'	=> 'L’identifiant que vous avez saisi a été interdit ou contient un mot interdit. Veuillez choisir un nom différent.',
